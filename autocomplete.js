document.addEventListener('DOMContentLoaded', function() {
    ...
    const cmsItems = ['ALDO', 'Abercrombie & Fitch', 'Adidas', 'Aesop', 'AllSaints', 'Alo Yoga', 'American Eagle Outfitters', 'Arcteryx', 'Aritzia', 'GEOX', 'Loblaws', 'Lululemon', 'Sephora', 'UGG', 'ZARA'];
