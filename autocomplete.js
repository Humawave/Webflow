document.addEventListener('DOMContentLoaded', function() {
    ...
    const cmsItems = ['Aldo', 'Abercrombie & Fitch', 'Adidas', 'Aesop', 'AllSaints', 'Alo Yoga', 'American Eagle Outfitters', 'Arcteryx', 'Aritzia', 'Athleta', 'Aveda', 'Banana Republic', 'Bath & Body Works', 'Best Buy', 'Boss Hugo Boss', 'Canada Goose', 'Club Monaco', 'Coach', 'Geox', 'Loblaws', 'Lululemon', 'Sephora', 'UGG', 'Zara'];
